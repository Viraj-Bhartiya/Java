PFont myFont;   // Font class decalred inline in Processing. Declared this to use as title font for the artwork.

float r = -15;                     // Start angle or arc
float rad = 350;                   // Radius of arc
float sw = 3;                      // Stroke-width of arc

String s = "A Platform For Creative Coding";
...
void keyPressed() {
  save("Citrus.png");      // Key Press saves the current frame of the render as an  artwork to the local system storage.
}
